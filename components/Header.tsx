      ...
      >
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <button
              onClick={toggleTheme}
              className="w-full text-left px-4 py-3 rounded-lg font-medium transition-colors text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center space-x-3"
              role="menuitem"
              aria-label={`Switch to ${isDark ? 'light' : 'dark'} mode`}
            >
              {isDark ? (
