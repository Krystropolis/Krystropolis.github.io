    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-gray-100 mb-6 tracking-tight">
        ...
        {/* Cards Section */}
        <div className="grid md:grid-cols-3 gap-6 mt-16 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
